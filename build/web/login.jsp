...
<html lang="zxx">
    ...
    <head>
        ...
        <title>Shree Hari | Customer Login</title>
    ...
    <body>
        ...
        <div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <!-- Login Form -->
                <form method="post" action="login-process.jsp" onsubmit="return validateform()" name="myform">
                    ...
                    <div class="group-input gi-check">
                        ...
                        <p style="color:red">
                            <%
                                String errors = (String) session.getValue("errors");
                                if (errors == "1") {
                                    out.println("<h7>Enter correct credentials</h7>");
                                    session.putValue("errors", "0");
                                }
                ...
                <div id="formFooter">
                    ...
                    <a class="underlineHover" style="text-decoration: none;" href="./register.jsp">Create New Account</a><br><br>
                </div>
