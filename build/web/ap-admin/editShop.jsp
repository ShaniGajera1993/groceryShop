...
if (pName==null || pName==""){  
  ...
  return false;  
    ...
    <title>Shree Hari | Update Shop</title>
   ...
   <br><br><div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <div class="fadeIn first">
                    <span class="one">Update Shop Page</span>
                </div>
                <%String email= request.getParameter("email");%>
                <!-- Login Form -->
                <form method="post" action="editProductToDb.jsp" onsubmit="return validateform()" name="myform">
                    ...
                    <%
                        ...
                        String sPassword = "";
                                                            ...
                                                            {
                                                                if(resultSet1.getString("email").equals(email))
                                                                {

                                                                    shopName = resultSet1.getString("shopName");
                                                                    Email = resultSet1.getString("email");
                                                                    adress = resultSet1.getString("address");
                                                                    sPassword = resultSet1.getString("password");
                        ...
                        %>
                    <input type="text" id="login" name="sName" class="fadeIn second" value="<%out.println(shopName);%>" >
                    <input type="text" id="login" name="sEmail" class="fadeIn third" value="<%out.println(Email);%>">
                    <input type="text" id="login" name="sAddress" class="fadeIn fourth" value="<%out.println(adress);%>">
                    <input type="text" id="login" name="sPassword" class="fadeIn fourth" value="<%out.println(sPassword);%>">
                    
              
                    <input type="submit" class="fadeIn seven" value="Update Shop">
                </form>
