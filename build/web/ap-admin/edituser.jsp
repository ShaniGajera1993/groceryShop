...
<body>
   ...
   <br><br><div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <!-- Login Form -->
                <form method="post" action="editusertodb.jsp" onsubmit="return validateform()" name="myform">
                    ...
                    <%
                        ...
                        String password = "";
                                                            ...
                                                            {
                                                                if(resultSet1.getString("useremail").equals(email))
                                                                {

                                                                    userfName = resultSet1.getString("userfName");
                                                                    userlName = resultSet1.getString("userlName");
                        ...
                        %>
                    <input type="text" id="login" name="userfname" class="fadeIn second" value="<%out.println(userfName);%>" >
                    <input type="text" id="login" name="userlname" class="fadeIn third" value="<%out.println(userlName);%>">
                    <input type="text" id="login" name="address" class="fadeIn fourth" value="<%out.println(address);%>">
                    <input type="text" id="login" name="password" class="fadeIn fourth" value="<%out.println(password);%>">
