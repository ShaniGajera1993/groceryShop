...
if (pName==null || pName==""){  
  ...
  return false;  
    ...
    <title>Shree Hari | Update Delivery Boy</title>
   ...
   <br><br><div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <div class="fadeIn first">
                    <span class="one">Update Delivery Boy</span>
                </div>
                <%String email= request.getParameter("email");%>
                <!-- Login Form -->
                <form method="post" action="editdboytodb.jsp" onsubmit="return validateform()" name="myform">
                    ...
                    <%
                        ...
                        String dPhone = "";
                                                            ...
                                                            {
                                                                if(resultSet1.getString("dBoyEmail").equals(email))
                                                                {

                                                                    dFName = resultSet1.getString("dBoyFName");
                                                                    dLName = resultSet1.getString("dBoylName");
                                                                    dEmail = resultSet1.getString("dBoyEmail");
                                                                    dPhone = resultSet1.getString("dBoyPhone");
                        ...
                        %>
                    <input type="text" id="login" name="dFName" class="fadeIn second" value="<%out.println(dFName);%>" >
                    <input type="text" id="login" name="dLName" class="fadeIn third" value="<%out.println(dLName);%>">
                    <input type="text" id="login" name="dEmail" class="fadeIn fourth" value="<%out.println(dEmail);%>">
                    <input type="text" id="login" name="dPhone" class="fadeIn fourth" value="<%out.println(dPhone);%>">
                    
              
                    <input type="submit" class="fadeIn seven" value="Update Boy">
                </form>
