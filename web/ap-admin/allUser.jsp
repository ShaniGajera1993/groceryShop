...
.fadeInDown {
    ...
    <title>Shree Hari | All User</title>
...
while(resultSet.next())
{
       ...
       %>
                        ...
                        <tr >
                            ...
                            <td>
                                    <center><%=resultSet.getString("userfname") %> </center>
                            </td>
                            
                             
                                
                            <td><center><%=resultSet.getString("userlname") %></center></td>
                                 
                             <td><center><%=resultSet.getString("useremail") %></center></td>
            
                             <td><center><%=resultSet.getString("address") %></center></td>
                        
                            <td><center><a id='edit' class="fa fa-edit" href="edituser.jsp?email=<%=resultSet.getString("useremail") %>" /></center></td>
                        
                            <td><center><a id='delete' class="fa fa-trash" href="DeletUserJsp.jsp?email=<%=resultSet.getString("useremail") %>" /></center></td>
