...
session.putValue("ShopName", ShopName);
...
<section class="latest-blog spad">
            <div class="container fadeInDown">
                ...
                <%
                    String shopName=request.getParameter("ShopName");
                %>
                <br><h4><center>Welcome to <%=shopName%></center></h4>
                <center><table>
                        <tr>
                            ...
                            <%
                                ...
                                try {
                                    ...
                                    while (resultSet.next()) {
                                      if(resultSet.getString("shopName").equals(ShopName)){ 
                            %>
                            ...
                            <td> 
                                <div id="rcorners1">
                                    <table> 
                                        ...
                                        <tr>
                                            <td>                                  
                                        <h5><%=resultSet.getString("productName")%> </h5>
                                        </td>
                                        </tr>
                                        <tr>
